...
namespace SnakeUi.Controller
{
    ...
    /// </summary>
    internal class GameManagerSiKo
    {
        ...
        public static GameManagerSiKo Instance
        {
            get
            {
                if (GameManagerSiKo._instance == null)
                {
                    GameManagerSiKo._instance = new GameManager();
                }

                return GameManagerSiKo._instance;
            }
        }

        private GameManagerSiKo()
        {
